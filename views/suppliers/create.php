    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form method="post" action="/suppliers/<?= $action === 'add' ? 'store' : 'update/' . $supplier['id'] ?>">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nom">Nom <span class="text-danger">*</span></label>
                            <input type="text" class="form-control <?= isset($errors['nom']) ? 'is-invalid' : '' ?>" id="nom" name="nom" value="<?= $old['nom'] ?? ($supplier['nom'] ?? '') ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="adresse" name="adresse" rows="3"><?= $old['adresse'] ?? ($supplier['adresse'] ?? '') ?></textarea>
                        </div>
